      ...
      <div className="prose prose-ink space-y-10 text-ink/80 leading-relaxed">
        ...
        <section>
          ...
          <p>
            ...
            under these terms shall be resolved in the courts of Marion County, Florida.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            <a href="/quote" className="text-rust hover:underline">
              quote request form
            </a>{" "}
            and note &ldquo;Legal inquiry&rdquo; in the notes field.
          </p>
        </section>
